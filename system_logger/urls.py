...
urlpatterns = [
    ...
    # ── Log page ──────────────────────────────────────────
    path('log/',                      views.log_view,       name='system_log'),
    path('log/metrics/',              views.metrics_data,   name='log_metrics'),
    path('log/activity/',             views.activity_data,  name='log_activity'),
    path('log/live-users/',           views.live_users,     name='log_live_users'),
    path('log/users/', views.users_list, name='log_users'),
]